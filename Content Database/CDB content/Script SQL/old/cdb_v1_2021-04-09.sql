...
CREATE TABLE "ESTAT"."V1"."dat_sources" (
  ...
  "link_id" bigint NOT NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT FK_LINK_SOURCES_CONCEPT FOREIGN KEY ("link_id") REFERENCES "ESTAT"."V1"."dat_link_info" ("id"),
  CONSTRAINT FK_CONCEPT_SOURCES_CONCEPT FOREIGN KEY ("concept_id") REFERENCES "ESTAT"."V1"."dat_concept" ("id")
)
...
CREATE TABLE "ESTAT"."V1"."dat_statistical_data" (
  ...
  "link_id" bigint NOT NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT FK_LINK_STAT_DATA_CONCEPT FOREIGN KEY ("link_id") REFERENCES "ESTAT"."V1"."dat_link_info" ("id"),
  CONSTRAINT FK_CONCEPT_STAT_DATA_CONCEPT FOREIGN KEY ("concept_id") REFERENCES "ESTAT"."V1"."dat_concept" ("id")
)
...
CREATE TABLE "ESTAT"."V1"."dat_redirections" (
  ...
  "link_id" bigint NOT NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT FK_LINK_REDIRECTION_CONCEPT FOREIGN KEY ("link_id") REFERENCES "ESTAT"."V1"."dat_link_info" ("id"),
  CONSTRAINT FK_CONCEPT_REDIRECTION_CONCEPT FOREIGN KEY ("concept_id") REFERENCES "ESTAT"."V1"."dat_concept" ("id")
)