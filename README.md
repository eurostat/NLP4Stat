...
- [Content and Knowledge Database latest documentation](NLP4StatRef-CD-KD-Documentation.docx): the latest documentation in a Word file, as of February 2022. This describes the version of the knowledge database **before the organization**.
- [Knowledge Database latest documentation](KD_Documentation.docx): the latest documentation of the knowledge database **after the re-organization** in a Word file, as of April 2022. 
- Use Case A:
