...
**B. /LDA_2/tests-topic-mod-altern-v1.ipynb**: Jupyter notebook of an alternative implementation of the LDA algorithm using the textmineR package and some more results. The topics are quite similar with the ones with algorithm A. Also, transferred to Kaggle, see **[here](https://www.kaggle.com/spiliopoulos/tests-topic-mod-altern-v1-md)**.
